    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {showResults && lastScore && (
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
          <h2 className="text-xl font-bold text-green-800 mb-2">Exercise Complete!</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Choose Exercise Type</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {exercises.map((exercise) => (
                <button
                  key={exercise.type}
                  onClick={() => handleStartExercise(exercise.type)}
                  className="group bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-lg p-6 text-left transition-all duration-200 transform hover:scale-105 border-2 border-transparent hover:border-blue-300"
                >
